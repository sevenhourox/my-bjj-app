...
const VideoCourseApp = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {activeTab === 'store' && (
        <View style={styles.card}>
          <Text style={styles.videoTitle}>Buy Premium Access</Text>
          <Text style={styles.videoDesc}>Unlock exclusive content by purchasing access.</Text>
          <TouchableOpacity style={styles.videoPlaceholder} onPress={() => Linking.openURL('https://buy.stripe.com/test_123456789')}>
            <Text style={styles.placeholderText}>Go to Checkout</Text>
          </TouchableOpacity>
        </View>
      )}
    </SafeAreaView>
